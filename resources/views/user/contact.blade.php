...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +20 50 2165084</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span> glorydental@gmail.com</a>
            </div>
          </div>
  ...
  <div class="page-section">
    <div class="container">
      ...
      <form class="contact-form mt-5" action="{{url('contact_us')}}" method="post">
      @csrf
        <div class="row mb-3">
